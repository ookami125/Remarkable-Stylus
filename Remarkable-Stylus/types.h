...
static const std::unordered_map<int, std::unordered_map<int, std::string>> codes = {
	{0, std::unordered_map<int, std::string>{
		{0, "SYN_REPORT"},
		{1, "SYN_CONFIG"},
		{2, "SYN_MT_REPORT"},
		{3, "SYN_DROPPED"},
	...
	{2, std::unordered_map<int, std::string>{
		{0, "REL_X"},
		{1, "REL_Y"},
		{2, "REL_Z"},
		{3, "REL_RX"},
	...
	{3, std::unordered_map<int, std::string>{
		{0, "ABS_X"},
		{1, "ABS_Y"},
		{2, "ABS_Z"},
		{3, "ABS_RX"},
	...
	{4, std::unordered_map<int, std::string>{
		{0, "MSC_SERIAL"},
		{1, "MSC_PULSELED"},
		{2, "MSC_GESTURE"},
		{3, "MSC_RAW"},
	...
	{5, std::unordered_map<int, std::string>{
		{0, "SW_LID"},
		{1, "SW_TABLET_MODE"},
	...
	{17, std::unordered_map<int, std::string>{
		{0, "LED_NUML"},
		{1, "LED_CAPSL"},
		{2, "LED_SCROLLL"},
		{3, "LED_COMPOSE"},
	...
	{18, std::unordered_map<int, std::string>{
		{0, "SND_CLICK"},
		{1, "SND_BELL"},
		{2, "SND_TONE"},
		{3, "SND_03"},
	...
	{20, std::unordered_map<int, std::string>{
		{0, "REP_DELAY"},
		{1, "REP_PERIOD"}
	}},
	{21, std::unordered_map<int, std::string>{
		{0, "FF_STATUS_STOPPED"},
		{1, "FF_STATUS_MAX"},
		{2, "FF_02"},
		{3, "FF_03"},
	...
	{ 22, std::unordered_map<int, std::string>{}},
	{ 23, std::unordered_map<int, std::string>{}},
	{ 31, std::unordered_map<int, std::string>{}}
};
